...
def db_row_iter_mock(*args, **kwargs):
    with open('testdata/extractorxml/out.json', 'r') as fp:
...
class TrainerTestCase(unittest.TestCase):
    ...
    @patch('trainer.logging')
    @patch('core.trainer.trainer.Trainer.train')
    @patch('core.trainer.trainer.Trainer.test')
    ...
    @patch('trainer.logging')
    @patch('core.trainer.trainer.Trainer.train')
    @patch('core.trainer.trainer.Trainer.vect_data2csv')
    ...
    @patch('trainer.logging')
    @patch('core.trainer.trainer.Trainer.train')
    @patch('core.trainer.trainer.Trainer.store_feature_weights')
    @patch('core.trainer.trainer.Trainer.test')
