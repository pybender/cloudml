...
class TrainerSegmentTestCase(unittest.TestCase):
    ...
    def test_calculate_feature_weight(self):
        ...
        self.assertEquals(self._trainer.get_weights('USA')[1]['positive'][0], {'feature_weight': 0.172996340584816, 'name': u'contractor->skills->microsoft-word', 'weight': 0.17299634058481614})
